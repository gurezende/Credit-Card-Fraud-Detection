...
* *Data scaling and balancinginputation*: I have scaled some variables to make the data more uniform and used 
* **Oversampling and Undersampling** techniques to balance the dataset, as it contains only 0.17% of the minoritary class.
